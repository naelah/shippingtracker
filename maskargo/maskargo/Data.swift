...
let settings:[String] = ["Shipment is booked", "Shipment received from Agent", "Shipment manifested on a flight", "Shipment has departed", "Shipment checked in from a flight", "Consignee has been notified", "Shipment has been delivered"]
let forms:[String] = ["Charter Enquiry", "ULD Booking", "Warehouse Equipment booking", "Storage Booking", "MH Centrigrade Enquiry", "Vehicle Enquiry", "Rate Calculator"]
let form_subs:[String] = ["Commodity, Volume, Destination", "Palette, Container, both FOCA and MH", "Forklift, Dolly", "Cold Room, Strong Room", "","KCH, BKI- Compact, Sedan, MPV","Warehouse charges + airfreight charge - based on IATA rate"]
let information:[String] = ["Airlines and IATA Regulations", "Special Carg Relations", "GUideline for Special Product (Booking, Packaging)", "How-to for Cargo Walk-in Customers", "Office Directory(by Countries - GSA, GHA)", "Feedback Form", "MAB Kargo News & Promotion", "Product & Services (Animal Hotel, Halal Logistics", "Corporate Website"," LMS"]
